  ...
  return (
    <section className="relative flex items-center justify-center">
      <div className="relative flex w-[567px] justify-center z-10">
        <div className="z-20 w-[103px] h-[207px] rounded-[10.5px] overflow-hidden shadow-lg bg-[#111827]/75">
          ...
          <div className="px-12">
            ...
            <h6 className="font-extrabold mb-12 text-indigo-500">
